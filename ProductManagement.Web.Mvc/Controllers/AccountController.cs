...
using ProductManagement.Sessions;
using ProductManagement.Web.Models.Account;
using ProductManagement.Web.Views.Shared.Components.TenantChange;

namespace ProductManagement.Web.Controllers
{
    public class AccountController : ProductManagementControllerBase
    {
